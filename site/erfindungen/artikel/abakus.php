...
<div class='erfindung'>
	...
	<h1>Verwendung und Nutzen</h1>
	 <p>Jede Reihen, worauf die Steinchen oder Holzkugeln aufgefädelt sind, haben einen anderen Stellenwert. Somit kann im Zehnersyste, aber auch im 60er sySystem (Babylon) gerechnet werden. Dabei werden die Kügelchen mit den Fingern verschoben, um die Zahlen zu repräsentieren.</p>
	...
	<h1>Fun-Facts</h1>
	 <p>Einfache bunte Zählrahmen sind in Kinderzimmern anzutreffen. Stellen wir uns jede Zeile mit Kugeln als weitere Zehnerpotenz dar, so können wir mit Kinderzählrahmen oft bis 10 000 000 000 «rechnen».</p>

	<h1>Quellenangaben</h1>
	<p><a href='https://de.wikipedia.org/wiki/Abakus_(Rechenhilfsmittel)'>Wikipedia 2019</a></p>
</div>