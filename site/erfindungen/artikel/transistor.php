...
<div class='erfindung'>
	...
	<h1>Geschichte</h1>
	<p>Julius E. Lilienfeld beschreibt 1925 die Funktionsweise eines Feldeffekt-Transistors. 1947 wurde der Bipolartransistor von Walter Brattain aufgrund von Erkenntnissen von John Bardeen entwickelt.</p>
	 
	<h1>Verwendung und Nutzen</h1>
                         <p>Transistoren wirken als Verstärker von Strom. Eine kleine Eingangsspannung (typ. 0.7 Volt) an der Basis «öffnen» den Transistor und lassen den Strom quasi Widerstandsfrei von Emitter zum Kollektor fließen. Genau genommen handelt es sich um eine Strom-Verstärkung, die aber so groß ist, dass sie als elektronischer Schalter verwendet werden kann. 
  ...
  <p>Wie mit Transistoren eine NOT-Schaltung gebaut werden kann, erfahren Sie <a href='https://smoch.ch/erfindung.php/not_transistor'>hier</a>.</p>
	...
	<p><a href='https://de.wikipedia.org/wiki/Transistor'>Wikipedia</a></p>
</div>
